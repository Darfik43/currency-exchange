...
public class CurrencyRepository implements CrudRepository<Currency> {
    ...
    public Optional<Currency> findByName(String name) {
        final String query = "SELECT * FROM currencyexchanger.currencies WHERE id ='" + name + "'";
    ...
    public void save(Currency entity) {
        final String query = "INSERT INTO currencyexchanger.currencies (code, fullname, sign) " +
                "VALUES (?, ?, ?)";
